 ...
 *
 */
void File_v_SafeDatOpen(FILE **pFile_sudokuFile, char *dat_name, char *dat_mode);
...
void File_v_DatToList(FILE *pFile_sudokuFile, List_Element_t **firstElement);

void File_v_ListToDat(FILE *pFile_sudokuFile, List_Element_t *firstElement);
